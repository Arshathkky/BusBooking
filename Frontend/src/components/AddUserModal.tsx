...
const AddUserModal: React.FC<AddUserModalProps> = ({ onClose }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    phone: '',
    address: '',
    role: 'customer' as 'customer' | 'owner' | 'conductor' | 'admin',
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl w-full max-w-md relative overflow-y-auto max-h-[90vh] transition-colors">
        <button
          onClick={onClose}
        ...
        <div className="p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-2">Create a new user account</p>
          </div>
